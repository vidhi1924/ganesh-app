...
import 'package:ganesh/Menu/cards.dart';
...
List<String> items = ["Invitation", "Location", "Gallery", "Teaser"];

// List<Color> colors = [Color(0xff157747), Color(0xff70CFA4), Color(0xff1DA469)];
List<Color> colors = [Color(0xff116934), Color(0xff6FCCA1), Color(0xff1A8D4B)];
// 70CFA4
class _MenuState extends State<Menu> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color(0xff116934),
      body: SafeArea(
        child: Column(
